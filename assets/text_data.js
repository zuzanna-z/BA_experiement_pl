...
const instructions_trial = 'You are about to start a practice trial. Here you will be presented with a shape. Your task is to decide whether the shape on the screen is a triangle or a circle. You must press the "w" key on your keyboard, if the shape is a triangle or the "n" key  if the shape is a circle. Press "space" to begin.'

const instructions_polish = 'You have finished the practice task. You will now repeat the experiment on words instead of shapes. This time you will be presented with a word (in Polish) and must decide whether it is a real word or a nonsense word (i.e. string of letters with no meaning behind it). You must press the "w" key on your keyboard for a real word or the "n" key for a nonsense word. Press space to begin.'

const instructions_english = 'You have now finished the first test stage of this experiment. You will now repeat the same task. Once again you will be presented with a word (this time in English), you must decide whether it is a real word or a nonsense word. You must press the "w" key for a real word or the "n" key for a nonsense word. Press space to begin.'
